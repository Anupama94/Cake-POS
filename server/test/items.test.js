...
describe("Testing API calls for the resource 'item'", () => {
    ...
    it('should return an item unavailable error when an item is not found for given item id', (done) => {
        const itemServiceMock = {
            getItemById: () => {}
        };
    ...
    it('should return a NOT FOUND error when items are unavailable in the database', (done) => {
        const itemServiceMock3 = {
            getAllItems: () => {

            }
        };
        const mockItem = sandbox.stub(itemServiceMock3, 'getAllItems');
